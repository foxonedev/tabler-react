  ...
  render(): React.Node {
   /* const notificationsObjects = this.state.notificationsObjects || [];
    ...
    const accountDropdownProps = {
      ...
      name: `${currentUser.nomprenom}`,
      description: currentUser.codent,
      options: [
        ...
        { isDivider: true },
        { icon: "help-circle", value: "Besoins d\'aide?" },
        { icon: "log-out", value: "Se déconnecter", onClick: authenticationService.logout },
      ],
    };
